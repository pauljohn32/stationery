...
\guidesetup{%
  ...
  keywords={Sweave, guide, listings},
  title={Writing Sweaved Guides with the CRMDA Template},
...
That will create a folder ``\code{writeup/rnw2pdf-guide-sweave}''
...
\item ``instructions-rnw2pdf-guide-sweave''
\end{enumerate}

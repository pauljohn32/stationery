...
We suggest you
\begin{enumerate}
\item Compile this document \emph{./rnw2pdf.sh -{}-tangle=FALSE -{}-engine='\textquotedbl{}knitr\textquotedbl{}'
instructions-rnw2pdf-report-knit.Rnwas is }to test your setup
...
In a report, we do not usually have R output in the raw form as you
see above.

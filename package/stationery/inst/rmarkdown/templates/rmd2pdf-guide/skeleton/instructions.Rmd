...
numbered equations and cross references will succeed. For a numbered
...
To demonstrate a cross-reference, that is equation (\ref{eq:sem}). If
we put in another equation, you will see it is automatically numbered:
...
want. It is close to what we want. The default is based on the Chicago
author-year format.

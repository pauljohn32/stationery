...
convenient for inspection by users.% Please leave this code
...
@
\fvset{listparameters={\setlength{\topsep}{0em}}}
\SweaveOpts{prefix.string=tmpout/t, split=TRUE, ae=FALSE, height=4, width=6}% This concerns images. The guide format on which this is 

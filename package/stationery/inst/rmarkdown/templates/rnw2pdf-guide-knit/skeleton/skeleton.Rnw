...
\begin{enumerate}
\item Brief instruction sheet in same folder as this skeleton: ``rnw2pdf-guide-knitr''
...
Listing objects differ in output from R code chunks-

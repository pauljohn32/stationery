...
% THE FOLLOWING LINE CAUSES AN ERROR AND DOCUMENT DOES NOT COMPILE
% \fvset{listparameters={\setlength{\topsep}{0em}}}
% \SweaveOpts{prefix.string=tmpout/t,split=T,ae=F,height=3,width=5}

<<include=F>>=
library(knitr)
opts_chunk$set(fig.path="tmpout/t-", split=TRUE, ae=FALSE, fig.height=3, fig.width=5, comment=NA)
@
...
Here is an example of a data frame being created:
...
This document edits margins in the preamble, don't use the LyX pull
down menu to revise them. 

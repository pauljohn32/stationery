...
Callout usage is demonstrated in the following. These are always
   ...
   able to negotiate on your choice of colors. Run the render script
   with this document, you'll see what we mean - please open a
   terminal and run
...
Accented letters (often in non-English names)

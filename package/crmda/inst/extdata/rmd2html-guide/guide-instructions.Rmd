...
Rstudio has great resources for R markdown basics. If you are a begginer to R markdown, we recommend covering some of RStudio's R markdown basics.
...
External images can be embedded into html documents by calling html code. By using html, we avoid potential rescaling issues through the pandoc conversion process. Html will also give us optimal flexability in rescaling. This can be achieved with the following html code:

```
<img src="plot1.png" alt = "Floating .png"
  width  = "308"
  height = "216">
...
We can insert more than just .png files, here is a .jpeg:

<img src="ext_img/plot3.jpeg" alt = "An external .jpeg"
  width  = "308"
  height = "216">

Currently .pdf files cannot be embedded in html documents, but there are methods for converting them. Either on the web at websites like:

http://pdf2png.com/

or through open source software like gimp:

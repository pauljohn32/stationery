...
%% MUST ESCAPE Commas in values! See lthree example of that
\guidesetup{%
  firstauthor={last name=Author, first name=First, affiliation=CRMDA, email=lone.edu},
  secondauthor={lastname=Author, firstname=Second, affiliation=CRMDA, email=g},
...
This chunk tests long names, line wrap

...
\includegraphics[width=2in,bb = 0 0 200 100, draft, type=eps]{theme/CRMDA_logo.pdf}\tabularnewline
\hline 
...
Please see the ``report-knit-example'' document if you want more
detailed information about what to do.

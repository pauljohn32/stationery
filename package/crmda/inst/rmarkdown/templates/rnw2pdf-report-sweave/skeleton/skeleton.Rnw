...
\includegraphics[width=2in]{theme/CRMDAlogo}\tabularnewline
\hline 
\multicolumn{2}{>{\raggedright}p{5in}}{\medskip{}
Author One, Title, CRMDA <email@ku.edu>

Author Two, Title, CRMDA <email@ku.edu>
...
Don't change the 3 code chunks above or the last chunk below.
...
We have separate instructions for the crmda package in vignettes.
if you want more detailed information about what to do.

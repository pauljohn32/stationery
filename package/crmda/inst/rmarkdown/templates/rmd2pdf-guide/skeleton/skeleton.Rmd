...
This document includes R[@RCore] code chunks. Because it is a guide, 
we expect we will need to display both R input and output.
Guide documents have numbered listings, as you see below.

--- 
title: "Stationery"
subtitle: "CRDMA Guides and Reports"
...
styles that work for their purposes. In the `stationery` package, we have
...
launches a function in the `stationery` package. As a result, there should
...
`stationery` package.  Hence, the help page for `rmd2pdf` should be consulted
...
that are place in the `stationery` package.
...
`pandoc` from the `stationery` package's install folder.  That is to say,

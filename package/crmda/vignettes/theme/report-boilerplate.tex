...
\rfoot{}
\renewcommand{\headrulewidth}{0pt}
\fancyfoot[L]{$if(addr1a)$$addr1a$\\$endif$$if(addr1b)$$addr1b$\\$endif$$if(addr1c)$$addr1c$$endif$}
\fancyfoot[R]{$if(addr1a)$$addr2a$\\$endif$$if(addr2b)$$addr2b$\\$endif$$if(addr2c)$$addr2c$$endif$}

...
with PDF from the `crmda` vignette.
...
The package `pander` is a great table producing package which offers
flexability and functionality. It can display an R table, the
coefficient object generated by a regression summary
